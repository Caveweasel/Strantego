...
func position_has_obstacle(obstacle_position: Vector2, ignore_obstacle_position = null) -> bool:
	...
	for obstacle in obstacles:
		if obstacle.global_position - Vector2(64,64) == obstacle_position: return true
	return false
...
func position_has_unit(unit_position: Vector2, ignore_unit_position = null) -> bool:
	...
	for unit in units:
		if unit.global_position - Vector2(64,64) == unit_position: return true
	return false
...
func set_obstacles_points_disabled(value: bool) -> void:
	for obstacle in obstacles:
		astar.set_point_disabled(get_point(obstacle.global_position - Vector2(64,64)), value)
...
func set_unit_points_disabled(value: bool, exception_units: Array = []) -> void:
	for unit in units:
		if unit in exception_units or unit.owner in exception_units:
			continue
		astar.set_point_disabled(get_point(unit.global_position - Vector2(64,64)), value)
